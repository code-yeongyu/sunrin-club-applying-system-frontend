...
router.post("/", function (req, res) {
    ...
    let content02 =
        ...
        req.body.textarea02
            ...
            .replace("&lt;br/&gt;", "<br/>")
    let content03 =
        "질문 3 (*필수) 주분야 또는 전공에 대한 자신의 경험을 서술해주세요" +
        "<br/>" +
        req.body.textarea03
            .replace(/(?:\r\n|\r|\n)/g, "<br/>")
            .replace("<", "&lt;")
    ...
    let content05 =
        ...
        req.body.textarea05
            ...
            .replace("&lt;br/&gt;", "<br/>")
    let content06 =
        "질문 6 (*선택) 포트폴리오가 있으시다면 아래 구글드라이브 링크로 제출해주시기 바랍니다" +
        "<br/>" +
        req.body.textarea06
            .replace(/(?:\r\n|\r|\n)/g, "<br/>")
            .replace("<", "&lt;")
