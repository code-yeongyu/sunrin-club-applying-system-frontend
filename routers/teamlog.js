...
router.post("/", function (req, res) {
    ...
    let content01 =
        "질문 1 TeamLog에 지원한 동기에 대하여 서술하여 주세요 : " +
        "<br/>" +
        req.body.textarea01
            .replace(/(?:\r\n|\r|\n)/g, "<br/>")
            .replace("<", "&lt;")
            ...
            .replace("&lt;br/&gt;", "<br/>")
    let content02 =
        "질문 2 본인이 전공(C언어, 파이썬, HTML/CSS, 리눅스 등)을 어디까지 공부하였는지 서술하여 주세요 : " +
        "<br/>" +
        req.body.textarea02
            .replace(/(?:\r\n|\r|\n)/g, "<br/>")
            .replace("<", "&lt;")
            ...
            .replace("&lt;br/&gt;", "<br/>")
    let content03 =
        "질문 3 자신이 TeamLog에서 희망하는 전공(ex: 네트워크, 웹, 서버)과 그 이유에 관하여 서술하여 주세요 : " +
        "<br/>" +
        req.body.textarea03
            .replace(/(?:\r\n|\r|\n)/g, "<br/>")
            .replace("<", "&lt;")
            ...
            .replace("&lt;br/&gt;", "<br/>")
    let content04 =
        "질문 4 TeamLog에 입부하면 자신이 어떠한 노력을 할 것인지 서술해 주세요 : " +
        "<br/>" +
        req.body.textarea04
            .replace(/(?:\r\n|\r|\n)/g, "<br/>")
            .replace("<", "&lt;")
